...
saveRDS(ehype, "data/quick_save2_1_env.rds")
...
gc()
saveRDS(ehype, "data/quick_save2_2_env.rds")
...
saveRDS(ehype, "data/quick_save2_3_env.rds")
...
rm(dem);gc()
saveRDS(ehype, "data/quick_save2_4_env.rds")
